...
```bash
  ...
  Fus2_genome=assembly/merged_canu_spades/F.oxysporum_fsp_cepae/Fus2_canu_new/edited_contigs/Fus2_canu_new_contigs_edited.fasta
  ...
  for GffFile in $(ls analysis/blast_homology/F.oxysporum_fsp_cepae/Fus2_canu_new/*_chr_*_gene_single_copy.aa_hits.gff); do
