...
Aug_Regex_RxLR_FA=analysis/RxLR_effectors/RxLR_EER_regex_finder/$Organism/$Strain/"$Strain"_Aug_RxLR_EER_regex.fa
...
Aug_hmm_WY_FA=analysis/RxLR_effectors/hmmer_WY/$Organism/$Strain/"$Strain"_Aug_WY_hmmer.fa
...
echo "4"
ORF_Regex_RxLR_FA=analysis/RxLR_effectors/RxLR_EER_regex_finder/$Organism/$Strain/"$Strain"_ORF_RxLR_EER_regex.fa
...
ORF_hmm_WY_FA=analysis/RxLR_effectors/hmmer_WY/$Organism/$Strain/"$Strain"_ORF_WY_hmmer.fa
...
Aug_hmm_RxLR_DB=$WorkDir/"$Strain"_Aug_RxLR_EER_WY_RxLR_rxlr.db
Aug_mimp_DB=$WorkDir/"$Strain"_Aug_RxLR_EER_WY_RxLR_mimps_rxlr.db
...
ORF_hmm_RxLR_DB=$WorkDir/"$Strain"_ORF_RxLR_EER_WY_RxLR_rxlr.db
ORF_mimp_DB=$WorkDir/"$Strain"_ORF_RxLR_EER_WY_RxLR_mimps_rxlr.db
