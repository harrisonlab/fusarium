...
nonpath=subset(df1, df1[,"A28"] == 1 & df1[,"CB3"] == 1 & df1[,"PG"] == 1 & df1[,"fo47"] == 1 & df1[,"A13"] == 1 & df1[,"Fus2"] == 0 & df1[,"125"] == 0 & df1[,"A23"] == 0)
path=subset(df1, df1[,"A28"] == 0 & df1[,"CB3"] == 0 & df1[,"PG"] == 0 & df1[,"fo47"] == 0 & df1[,"A13"] == 0 & df1[,"Fus2"] == 1 & df1[,"125"] == 1 & df1[,"A23"] == 1)
orthologs=subset(df1, df1[,"A28"] == 1 & df1[,"CB3"] == 1 & df1[,"PG"] == 1 & df1[,"fo47"] == 1 & df1[,"A13"] == 1 & df1[,"Fus2"] == 1 & df1[,"125"] == 1 & df1[,"A23"] == 1)
...
n12=nrow(subset(df1, df1[,"A28"] == 1 & df1[,"CB3"] == 1 & df1[,"PG"] == 1 & df1[,"fo47"] == 1 & df1[,"A13"] == 1 & df1[,"Fus2"] == 1 & df1[,"125"] == 1 & df1[,"A23"] == 1))
summary(n12)
pdf(o)
...
print("A13")
total_7 = nrow(subset (df1, df1[,"A13"] == 1))
missing_7 = (total_7 - area2)
uniq_7=sum(singles[, "A13"])
...
print("fo47")
total_8 = nrow(subset (df1, df1[,"fo47"] == 1))
missing_8 = (total_8 - area2)
uniq_8=sum(singles[, "fo47"])
paste('The total number of orthogroups and singleton genes in this isolate: ', total_8)
paste('The total number of orthogroups and singleton genes not in the venn diagram: ', missing_8)
paste('The total number of singleton genes not in the venn diagram: ', uniq_8)
