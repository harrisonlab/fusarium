...
```bash
cp $OutDir/FoN_FoL_genome_edited.txt $OutDir/FoN_FoL_genome_edited2.txt
nano $OutDir/FoN_FoL_genome_edited2.txt
cp $OutDir/FoN_FoL_genome_edited2.txt $OutDir/FoN_FoL_genome_final.txt
``` -->
...
```bash
ProgDir=/home/armita/git_repos/emr_repos/scripts/fusarium/pathogen/identify_LS_chromosomes/circos
circos -conf $ProgDir/FoN_A8/FoN_FoL/FoN_FoL_circos.conf -outputdir $OutDir
mv $OutDir/circos.png $OutDir/FoN_FoL_circos.png
mv $OutDir/circos.svg $OutDir/FoN_FoL_circos.svg
```
