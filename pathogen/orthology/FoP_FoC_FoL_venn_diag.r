...
n12=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1))
n13=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"FoC"] == 1))
n14=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"FoL"] == 1))
n15=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"R2"] == 1))
n23=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"FoC"] == 1))
n24=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"FoL"] == 1))
n25=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"R2"] == 1))
n34=nrow(subset(df1, df1[,"FoC"] == 1 & df1[,"FoL"] == 1))
n35=nrow(subset(df1, df1[,"FoC"] == 1 & df1[,"R2"] == 1))
n45=nrow(subset(df1, df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n123=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"FoC"] == 1))
n124=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"FoL"] == 1))
n125=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"R2"] == 1))
n134=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"FoC"] == 1 & df1[,"FoL"] == 1))
n135=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"FoC"] == 1 & df1[,"R2"] == 1))
n145=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n234=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"FoC"] == 1 & df1[,"FoL"] == 1))
n235=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"FoC"] == 1 & df1[,"R2"] == 1))
n245=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n345=nrow(subset(df1, df1[,"FoC"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n1234=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"FoC"] == 1 & df1[,"FoL"] == 1))
n1235=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"FoC"] == 1 & df1[,"R2"] == 1))
n1245=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n1345=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"FoC"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n2345=nrow(subset(df1, df1[,"F81"] == 1 & df1[,"FoC"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
n12345=nrow(subset(df1, df1[,"F1EMR"] == 1 & df1[,"F81"] == 1 & df1[,"FoC"] == 1 & df1[,"FoL"] == 1 & df1[,"R2"] == 1))
