...
FORWARD_FILE2=$3
REVERSE_FILE2=$4
WORK_DIR=$TMPDIR/Fus2_combined

mkdir -p $WORK_DIR
cd $WORK_DIR
velveth $WORK_DIR 41,101,2 -fastq -shortPaired -separate $CUR_DIR/$FORWARD_FILE1 $CUR_DIR/$REVERSE_FILE1 -shortPaired2 -separate $CUR_DIR/$FORWARD_FILE2 $CUR_DIR/$REVERSE_FILE2
